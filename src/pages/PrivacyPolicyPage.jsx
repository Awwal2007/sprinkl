...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen flex flex-col bg-dark-bg text-slate-800 dark:text-slate-100 selection:bg-brand-500 selection:text-slate-950 font-sans transition-colors">
      <SEO
      ...
      <main className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-xs font-bold text-slate-500 dark:text-dark-muted hover:text-brand-600 dark:hover:text-brand-400 mb-8 transition-colors group"
        >
        ...
        {/* Header */}
        <header className="border-b border-slate-200 dark:border-dark-border/80 pb-8 mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-500/10 border border-brand-500/20 text-brand-600 dark:text-brand-400 text-xs font-bold mb-4">
          ...
          <p className="text-sm sm:text-base text-slate-600 dark:text-dark-muted max-w-2xl leading-relaxed">
            At <strong>Sprinkl</strong> (accessible via <code className="text-brand-600 dark:text-brand-400 font-mono">https://www.sprinkl.biz</code>),
            protecting the privacy and financial data of our giveaway hosts and winners is our highest priority.
          </p>
          <div className="flex flex-wrap items-center gap-4 text-xs text-slate-500 dark:text-dark-muted mt-4 font-mono">
        ...
        <article className="space-y-10 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
          ...
          <section className="space-y-3">
            ...
            <div className="grid sm:grid-cols-2 gap-4 pt-2">
              <div className="bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border rounded-2xl p-5 space-y-2 shadow-sm">
                <h3 className="font-extrabold text-slate-900 dark:text-white text-sm flex items-center gap-2">
                  <Database className="w-4 h-4 text-brand-600 dark:text-brand-400" />
                  <span>Giveaway Hosts</span>
                </h3>
                <ul className="text-xs text-slate-600 dark:text-dark-muted space-y-1.5 list-disc pl-4">
          ...
          <section className="space-y-3 bg-gradient-to-br from-rose-50/80 to-white dark:from-dark-card dark:to-rose-950/20 border border-rose-200 dark:border-rose-500/20 rounded-2xl p-6 shadow-sm">
            ...
            <div className="bg-white/90 dark:bg-dark-bg/80 border border-slate-200 dark:border-dark-border rounded-xl p-4 space-y-2 text-xs">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <span className="text-brand-600 dark:text-brand-400">4.</span>
            ...
            <p className="bg-slate-100 dark:bg-dark-card border border-slate-200 dark:border-dark-border rounded-xl p-3.5 font-mono text-xs text-slate-800 dark:text-slate-300">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <span className="text-brand-600 dark:text-brand-400">5.</span>
            ...
            <ul className="space-y-2 list-disc pl-5 text-xs text-slate-700 dark:text-slate-300">
              <li>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <span className="text-brand-600 dark:text-brand-400">6.</span>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <span className="text-brand-600 dark:text-brand-400">7.</span>
              <span>Your Rights Under NDPR &amp; GDPR</span>
            </h2>
            <p>As a data subject, you possess the right to:</p>
            <div className="grid sm:grid-cols-2 gap-3 pt-1">
              <div className="p-3.5 rounded-xl bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border text-xs shadow-sm">
                <p className="font-bold text-slate-900 dark:text-white mb-1">Right to Access</p>
                <p className="text-slate-500 dark:text-dark-muted">Request a copy of all personal data held about you on Sprinkl.</p>
              </div>
              <div className="p-3.5 rounded-xl bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border text-xs shadow-sm">
                <p className="font-bold text-slate-900 dark:text-white mb-1">Right to Erasure</p>
                <p className="text-slate-500 dark:text-dark-muted">Request permanent deletion of your profile and personal identifiers.</p>
              </div>
              <div className="p-3.5 rounded-xl bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border text-xs shadow-sm">
                <p className="font-bold text-slate-900 dark:text-white mb-1">Right to Rectification</p>
                <p className="text-slate-500 dark:text-dark-muted">Update or correct inaccurate account details or banking records.</p>
              </div>
              <div className="p-3.5 rounded-xl bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border text-xs shadow-sm">
                <p className="font-bold text-slate-900 dark:text-white mb-1">Right to Data Portability</p>
                <p className="text-slate-500 dark:text-dark-muted">Export your giveaway and ledger history in standard CSV/JSON format.</p>
              </div>
            </div>
          </section>

          {/* Section 8: Contact & Data Protection Officer */}
          <section className="space-y-3 pt-4 border-t border-slate-200 dark:border-dark-border">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <span className="text-brand-600 dark:text-brand-400">8.</span>
            ...
            <div className="p-5 rounded-2xl bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm">
              <div>
                <p className="font-bold text-slate-900 dark:text-white">Sprinkl Privacy &amp; Compliance Team</p>
                <p className="text-xs text-slate-500 dark:text-dark-muted font-mono mt-0.5">Website: https://www.sprinkl.biz</p>
                <p className="text-xs text-slate-500 dark:text-dark-muted font-mono">Location: Lagos, Nigeria</p>
              </div>
              <a
                href="mailto:support@sprinkl.biz"
                className="px-4 py-2.5 bg-brand-500 hover:bg-brand-600 text-slate-950 font-bold text-xs rounded-xl inline-flex items-center gap-2 transition-colors shrink-0 shadow-sm"
              >
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200 dark:border-dark-border py-8 text-center text-xs text-slate-500 dark:text-dark-muted bg-white/50 dark:bg-transparent">
