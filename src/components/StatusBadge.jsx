...
export default function StatusBadge({ status }) {
  const styles = {
    ...
    processing: 'bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-500/20 animate-pulse',
  ...
  const style = styles[status] || 'bg-slate-500/10 text-slate-600 dark:text-slate-400 border-slate-500/20';
